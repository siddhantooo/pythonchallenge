...
for i in range(3,len(text)-3):
	if text[i] in l and text[i-1] in L and text[i-2] in L and text[i-3] in L and text[i+1] in L and text[i+2] in L and text[i+3] in L and text[i-4] in l and text[i+4] in l:
		print(text[i-3]+text[i-2]+text[i-1]+text[i]+text[i+1]+text[i+2]+text[i+3])
